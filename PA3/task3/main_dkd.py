# main_dkd.py (Updated for Fair Comparison)
...
def main():
    """Main function to run the FAIR Decoupled KD experiment using Hub models."""
    ...
    experiment_name = "student_kd_dkd_hub"
    ...
    # Use our robust, faithful DKD loss function
    criterion_kd = losses.DKDLoss(
        beta=configs.DKD_BETA, 
        gamma=configs.DKD_GAMMA, 
        temperature=configs.KD_TEMPERATURE
    )
    ...
    print(f"Best Test Accuracy for Distilled Student (DKD, Fair): {best_acc:.2f}%")
